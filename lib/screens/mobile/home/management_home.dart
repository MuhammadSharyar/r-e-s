...
import 'package:r_e_s/screens/mobile/curriculum/curriculum.dart';
import 'package:r_e_s/screens/mobile/generate_exam/exam_types.dart';
import 'package:r_e_s/screens/mobile/student_form/student_form.dart';
...
class ManagementHome extends StatefulWidget {
  ManagementHome({Key? key}) : super(key: key);
...
class _ManagementHomeState extends State<ManagementHome> {
  ...
  Future getCards() async {
    ...
    userInfoController.permissions.value =
        userInfoController.userDetails['permissions'];
    print(userInfoController.permissions);
