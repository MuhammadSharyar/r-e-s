...
import 'package:r_e_s/screens/mobile/generate_exam/for_term_exams/generate_exam.dart';
...
class QuestionTypes extends StatelessWidget {
  final String forClass, forCourse, forTerm;
  QuestionTypes({
    Key? key,
    required this.forClass,
    required this.forCourse,
    required this.forTerm,
  }) : super(key: key);
