...
class GenerateExam extends StatelessWidget {
  ...
  final questionController = Get.put(GetWholeBookQuestionsController());
  ...
  Future generateExam1({
    ...
    while (pdfFile.existsSync()) {
      fileNum++;
      pdfFile = File("/storage/emulated/0/Download/${forCourse}__$fileNum.pdf");
    }
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                (questionTypes.contains("All Mcqs"))
                    ? Padding(
                    ...
                    : Container(),
                (questionTypes.contains("All Short Questions"))
                    ? Padding(
                        padding: const EdgeInsets.only(bottom: 10.0),
                        child: customTextField2(
                    ...
                    : Container(),
                (questionTypes.contains("All Long Questions"))
                    ? Padding(
                        padding: const EdgeInsets.only(bottom: 10.0),
                        child: customTextField2(
                    ...
                    : Container(),
                (questionTypes.contains("All Fill in the Blanks"))
                    ? Padding(
                        padding: const EdgeInsets.only(bottom: 10.0),
                        child: customTextField2(
                    ...
                    : Container(),
                (questionTypes.contains("All True False"))
                    ? Padding(
                        padding: const EdgeInsets.only(bottom: 10.0),
                        child: customTextField2(
                    ...
                    : Container(),
                (questionTypes.contains("All Letters"))
                    ? Padding(
                        padding: const EdgeInsets.only(bottom: 10.0),
                        child: customTextField2(
                    ...
                    : Container(),
                (questionTypes.contains("All Essays"))
                    ? Padding(
                        padding: const EdgeInsets.only(bottom: 10.0),
                        child: customTextField2(
                    ...
                    : Container(),
                (questionTypes.contains("All Stories"))
                    ? Padding(
                        padding: const EdgeInsets.only(bottom: 10.0),
                        child: customTextField2(
                    ...
                    : Container(),
                (questionTypes.contains("All Word Meanings"))
                    ? Padding(
                        padding: const EdgeInsets.only(bottom: 10.0),
                        child: customTextField2(
                  ...
                  onPressed: () async {
                    if (countController.count.value != 100) {
                      ...
                      for (int i = 0; i < questionTypes.length; i++) {
                        await questionController.getWholeBookQuestions(
                          forClass: forClass,
                          forCourse: forCourse,
                          questionType: questionTypes[i],
                        );
                        if (questionTypes[i] == "All Mcqs" &&
                        ...
                        } else if (questionTypes[i] == "All Short Questions" &&
                        ...
                        } else if (questionTypes[i] == "All Long Questions" &&
                        ...
                        } else if (questionTypes[i] == "All True False" &&
                        ...
                        } else if (questionTypes[i] == "All Letters" &&
                        ...
                        } else if (questionTypes[i] == "All Essays" &&
                        ...
                        } else if (questionTypes[i] == "All Stories" &&
                        ...
                        } else if (questionTypes[i] == "All Word Meanings" &&
